 ...
 *     """
 */
  __pyx_tuple__31 = PyTuple_Pack(16, __pyx_n_s_image, __pyx_n_s_fwhmx, __pyx_n_s_fwhmy, __pyx_n_s_thresh1, __pyx_n_s_thresh2, __pyx_n_s_boxFind, __pyx_n_s_boxCent, __pyx_n_s_nmin, __pyx_n_s_nmax, __pyx_n_s_maxIt, __pyx_n_s_verbose, __pyx_n_s_val, __pyx_n_s_cp, __pyx_n_s_npoint, __pyx_n_s_vals, __pyx_n_s_result); if (unlikely(!__pyx_tuple__31)) __PYX_ERR(0, 43, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_tuple__31);
  __Pyx_GIVEREF(__pyx_tuple__31);
  __pyx_codeobj__32 = (PyObject*)__Pyx_PyCode_New(11, 0, 16, 0, 0, __pyx_empty_bytes, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_tuple__31, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_kp_s_Users_karr_ics_mcsActor_python, __pyx_n_s_centroid_only, 43, __pyx_empty_bytes); if (unlikely(!__pyx_codeobj__32)) __PYX_ERR(0, 43, __pyx_L1_error)
