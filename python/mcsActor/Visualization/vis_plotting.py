...
def checkCentroids(xc,yc,cutrange,prefix):
    ...
    #display and save
    plt.show()
    plt.savefig(prefix+"_checkpoints.jpg")
...
def checkMatched(xx,yy,xs,ys,prefix):
    ...
    #save and show
    plt.savefig(prefix+"_checkpoints1.jpg")
    plt.show()

def plotDistortion(c,c1,pts1,pts2,diffx,diffy,fxs,fys,peaks,limit,prefix,units):
...
def plotVal(xs,ys,val,limit,plotrange,titl,prefix,suffix,units):
    ...
    plt.ylabel("Y ("+units+")")
    plt.show()
    plt.savefig(prefix+suffix+".jpg")

def checkPlots(files):
...
def plotTransByFrame(fxFrameAv,fyFrameAv,peakFrameAv,sxAll,syAll,xdAll,ydAll,rotAll):
    ...
    plt.savefig(prefix+"_fwhmbyframe.jpg")
    fig.show()
    ...
    plt.xlabel("Frame #")
    plt.ylabel("Peak")
    plt.savefig(prefix+"_peakbyframe.jpg")
    ...
    plt.xlabel("Frame #")
    plt.ylabel("Scale")
    plt.savefig(prefix+"_scalebyframe.jpg")
    ...
    plt.savefig(prefix+"_transbyframe.jpg")
    ...
    plt.savefig(prefix+"_rotbyframe.jpg")
